...
describe("User API Endpoints", () => {
  describe("GET /users", () => {
    it("should return a list of users", async () => {
      ...
      expect(responseBody.value.length).toEqual(users.length);
      responseBody.value.forEach((user, index) => compareUsers(users[index] as User, user));
    });
  });
  ...
  describe("GET /users/:id", () => {
    it("should return a user for a valid ID", async () => {
      ...
      compareUsers(expectedUser, responseBody.value);
    });
    ...
    it("should return a not found error for non-existent ID", async () => {
      ...
      expect(responseBody.message).toContain("User Tidak Ditemukan");
      expect(responseBody.value).toBeNull();
    });
